...
##### 1，三线图  
自变量：吸所有的毒品frequency。  
因变量：{bivariate（只分yes/no两种情况）} 酒驾，武器携带，自杀，戒烟，打架，初次性行为年纪（14以下和14以上，高中年龄）,屏幕使用（Q79+Q80>5小时，就是重度），睡眠时间（<8 or >8）,学习成绩（<c or >c)  
因变量：{多元} 吸烟（不吸，重度吸烟，轻度）, 喝酒（不喝醉，一月醉1～5天，一月醉6天以上Q42)  
