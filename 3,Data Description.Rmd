...
* `screening_use`: Hours of watching TV or using a computer on an average school day. 
* `sleeping_time`
* `smoking_status`
* `binge_drinking`
* `seat_belt`
