...
```{r three-line}
label(yrbss_state_tidy$drunk_driving) = "Drunk Driving"
label(yrbss_state_tidy$text_driving) = "Text Driving"
label(yrbss_state_tidy$carrying_weapon) = "Weapon Carrying"
label(yrbss_state_tidy$suicide_attempt) = "Suicide Attempt"
label(yrbss_state_tidy$quit_smoke) = "Quit Smoking"
label(yrbss_state_tidy$physical_fight) = "Physical Fight"
label(yrbss_state_tidy$early_sex) = "Sexual Intercourse"
label(yrbss_state_tidy$screening_use) = "Screening Use"
label(yrbss_state_tidy$sleeping_time) = "Sleeping Time"
label(yrbss_state_tidy$smoking_status) = "Smoking Status"
label(yrbss_state_tidy$binge_drinking) = "Binge Dringking"
label(yrbss_state_tidy$seat_belt) = "Seat Belt Use"
label(yrbss_state_tidy$grades_school) = "Grades in School"
...
```{r}
test_of_association(yrbss_state_tidy, "binge_drinking", "Table **: Drug Use Status vs Binge Drinking")
```
...
```{r}
test_of_association(yrbss_state_tidy, "seat_belt", "Table **: Drug Use Status vs Seat Belt Use")
...
```{r}
test_of_association(yrbss_state_tidy_grades_school, "grades_school", "Table **: Drug Use Status vs Grades in School")
```
