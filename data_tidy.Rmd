...
<<<<<<< HEAD
 ...
 # drop_na(q9,q10,q14,q17,q26,q39,q59,q79,q80,q88,q33,q42,q89,q8,q11) %>% 
=======
  drop_na(q45, q46, q50, q51, q52, q53, q54, q55, q56, q9, q10, q14, q17, q26, q39,q59, q79, q80, q88, q33, q42, q89, q8, q11, grade, race4, sex) %>% 
>>>>>>> 6ed398572dbe0de88ff2298e12d6ebc583a00546
  mutate(
...
yrbss_state_tidy_grades_school <- 
  yrbss_state_tidy %>% 
  drop_na(q89) %>% 
  filter(q89 < 6, sex != "Missing Gender") %>% 
  mutate(
...
drug1_smoke %>%
  ...
  mutate(position = rank(-percentage)) %>%
  ggplot(
       aes(x = drug_use_freq, y = percentage,
           fill = reorder(smoke_age,-percentage),group = position)
       ) +
  geom_bar(stat = "identity",                                     
           position = "dodge") +
...
drug1_alcohol %>%
  ...
  ggplot(
       aes(x = drug_use_freq, y = percentage,
           fill = reorder(alcohol_age,-percentage),group = position)
       ) +
  geom_bar(stat = "identity",                                     
           position = "dodge") +
  scale_y_continuous(breaks = seq(0, 2, .1), 
