...
```
From Table 9, p-value is not significantly small and effect size is small, implying that there is not a strong assiciation between screening use and drug use frequency. 
...
### Sleeping time
The density plot shows that heavy dose use subjects sleep less than no drug use subjects and light dose use subjects. Also, there are more portions of subjects who sleep less than 5 hours for heavy dose use compared to no drug use and light dose use. 
