...
yrbss_state_tidy <-
  ...
  select(drug_use_freq, grade, sex, bmi, race4, drunk_driving, text_driving, carrying_weapon, suicide_attempt, quit_smoke, physical_fight, early_sex, screening_use, sleeping_time, smoking_status, binge_drinking, seat_belt, grades_school, smoke_age, alcohol_age, bmi)
```
...
```{r}
test_of_association(yrbss_state_tidy_binge_drinking, "binge_drinking")
...
```{r}
test_of_association(yrbss_state_tidy_seat_belt, "seat_belt")
...
df = 
  ...
  mutate(
    ...
    select(drug_use_freq, drunk_driving, carrying_weapon, suicide_attempt, quit_smoke, physical_fight, early_sex, screening_use, smoking_status, binge_drinking, seat_belt, grades_school)


table1(~ drunk_driving + carrying_weapon + suicide_attempt + quit_smoke + physical_fight + early_sex + screening_use + smoking_status + binge_drinking + seat_belt + grades_school| drug_use_freq, data = df)
```
