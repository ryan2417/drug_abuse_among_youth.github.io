...
-  Density plots of BMI are all right-skewed, which means that the mean is greater than the median. Highest percentage of observations fall in 20-30 bmi. Based on the box-plot, medians for three dose usgae groups are similar. 
## Q11
```{r}
