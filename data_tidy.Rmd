...
```{r}
crude_analysis(yrbss_state_tidy_smoking_status, "smoking_status")
...
```{r}
grade_analysis(yrbss_state_tidy_smoking_status, "smoking_status")
...
```{r}
gender_analysis(yrbss_state_tidy_smoking_status, "smoking_status")
...
Over race
```{r}
race_analysis(yrbss_state_tidy_smoking_status, "smoking_status")
